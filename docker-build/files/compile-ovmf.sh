...
./BaseTools/BinWrappers/PosixLike/build -t GCC5 -a X64 -p OvmfPkg/OvmfPkgIa32X64.dsc -n $(nproc) -b RELEASE -D FD_SIZE_2MB -D SMM_REQUIRE -D SECURE_BOOT_ENABLE -D HTTP_BOOT_ENABLE -D TLS_ENABLE -D NETWORK_IP6_ENABLE -D TPM_ENABLE -D TPM_CONFIG_ENABLE -D EXCLUDE_SHELL_FROM_FD
